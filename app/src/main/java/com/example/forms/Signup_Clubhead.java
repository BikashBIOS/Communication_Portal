...
public class Signup_Clubhead extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_signup__clubhead);

        getSupportActionBar().setTitle("Club Head SignUp");
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference("Club Heads");
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(Signup_Clubhead.this, "Please enter your Name", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(uname))
                {
                    Toast.makeText(Signup_Clubhead.this, "Please enter user name", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(email))
                {
                    Toast.makeText(Signup_Clubhead.this, "Please enter Email", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(password))
                {
                    Toast.makeText(Signup_Clubhead.this, "Please enter password", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(cpassword))
                {
                    Toast.makeText(Signup_Clubhead.this, "Please enter confirm password", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (password.length()<6)
                {
                    Toast.makeText(Signup_Clubhead.this, "Password should be of 6 or more characters", Toast.LENGTH_SHORT).show();
                }
                if (cpassword.length()<6)
                {
                    Toast.makeText(Signup_Clubhead.this, "Confirmed Password less than 6 characters", Toast.LENGTH_SHORT).show();
                }
                ...
                if (password.equals(cpassword))
                {
                    firebaseAuth.createUserWithEmailAndPassword(email, password)
                            .addOnCompleteListener(Signup_Clubhead.this, new OnCompleteListener<AuthResult>() {
                                @Override
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    progressBar.setVisibility(View.GONE);
                                    if (task.isSuccessful()) {

                                        clubhead information=new clubhead(name,uname,email,gender,phone,scollege,sbranch,syear);

                                        FirebaseDatabase.getInstance().getReference("Club Heads")
                                        ...
                                        Toast.makeText(Signup_Clubhead.this, "Authentication Failed", Toast.LENGTH_SHORT).show();
                                    }
                ...
                {
                    Toast.makeText(Signup_Clubhead.this, "Confirmed Password not equal to Password", Toast.LENGTH_SHORT).show();
                }
